...
class GetMaxAvailableBufferSizeCommand extends RequestEnvelope {

	public ReplyEnvelope execute(Object context) throws Exception {
		return new NumberReplyEnvelope(getUid(), ((IDMAMemoryManager)context).getMaxAvailableBufferSize());
	}
