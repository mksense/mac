...
class GetBufferCommand extends RequestEnvelope {

	private String comment;
	private int size;

	public GetBufferCommand(int size, String comment) {
		this.size = size;
		this.comment = comment;
	}

	public ReplyEnvelope execute(Object context) throws Exception {
		return new NumberReplyEnvelope(getUid(), ((IDMAMemoryManager)context).getBuffer(size, comment));
	}
