...
class IsRadioReceiverOnCommand extends RequestEnvelope {
	
	public IsRadioReceiverOnCommand() {
	}

	public ReplyEnvelope execute(Object context) {
		boolean result = Spot.getInstance().getRadioPolicyManager().isRadioReceiverOn();
