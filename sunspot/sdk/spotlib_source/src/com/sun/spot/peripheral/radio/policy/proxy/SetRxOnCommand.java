...
class SetRxOnCommand extends RequestEnvelope {
	
	private boolean rxState;

	public SetRxOnCommand(boolean rxState) {
		this.rxState = rxState;
	}

	public ReplyEnvelope execute(Object context) {
		boolean result = Spot.getInstance().getRadioPolicyManager().setRxOn(rxState);
