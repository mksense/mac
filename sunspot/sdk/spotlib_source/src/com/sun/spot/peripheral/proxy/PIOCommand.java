...
public abstract class PIOCommand extends RequestEnvelope {
	private int pioSelector;
...
public PIOCommand(int pioSelector) {
	...
	public ReplyEnvelope execute(Object context) throws Exception {
		return execute(((ISpot)context).getAT91_PIO(pioSelector));
	}

	protected abstract ReplyEnvelope execute(IAT91_PIO pio) throws Exception;
}
