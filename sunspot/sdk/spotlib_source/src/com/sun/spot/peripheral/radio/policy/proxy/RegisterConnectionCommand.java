...
class RegisterConnectionCommand extends RequestEnvelope {
	private IConnectionID cid;
	
	public RegisterConnectionCommand(IConnectionID cid) {
		this.cid = cid;
	}

	public ReplyEnvelope execute(Object context) {
		Spot.getInstance().getRadioPolicyManager().registerConnection(cid);
