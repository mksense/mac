...
abstract class ProxyDriverRequestEnvelope extends RequestEnvelope {
	...
	public ReplyEnvelope execute(Object context) throws Exception {
		IDriverLookup lookup = (IDriverLookup) context;
		return execute(lookup.getDriverNamed(driverName));
	}
