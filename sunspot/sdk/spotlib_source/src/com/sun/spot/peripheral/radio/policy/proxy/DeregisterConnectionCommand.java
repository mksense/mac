...
class DeregisterConnectionCommand extends RequestEnvelope {
	private IConnectionID cid;
	
	public DeregisterConnectionCommand(IConnectionID cid) {
		this.cid = cid;
	}

	public ReplyEnvelope execute(Object context) {
		Spot.getInstance().getRadioPolicyManager().deregisterConnection(cid);
