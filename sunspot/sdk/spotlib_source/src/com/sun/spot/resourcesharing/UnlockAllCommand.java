...
public class UnlockAllCommand extends RequestEnvelope {

	private int isolateId;

	public UnlockAllCommand(int isolateId) {
		this.isolateId = isolateId;
	}

	public ReplyEnvelope execute(Object context) throws Exception {
		((IResourceRegistryMaster) context).unlockAllResourcesHeldByIsolate(isolateId);
