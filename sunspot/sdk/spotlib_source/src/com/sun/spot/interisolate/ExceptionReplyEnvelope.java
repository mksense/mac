 ...
 */
public class ExceptionReplyEnvelope extends ReplyEnvelope {
	private Throwable exception;

	public ExceptionReplyEnvelope(int requestUid, Throwable ex) {
		super(requestUid);
		this.exception = ex;
	}

	public void checkForThrowable() throws Throwable {
		throw exception;
	}
